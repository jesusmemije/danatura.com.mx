    ...
    e.fn.imageUploader = function(t) {
        ...
        i = {
            ...
            l=function(t,i,o) {
                ...
                return l.on("click",function(e){d(e)}),r.on("click",function(t){d(t);
                let o=l.parent();
            ...
            p=function(t){
                ...
                e(o).each(function(e,t){
                    a.settings.extensions&&!g(t)||a.settings.mimes&&!c(t)||a.settings.maxSize&&!f(t)||a.settings.maxFiles&&!m(l.length,t)||l.push(t)}),l.length?(i.removeClass("drag-over"),u(i,l)):n.prop("files",s.files)
            },
            g=function(e){
            ...
            m=function(e,t){
                return!(e+s.items.length+a.settings.preloaded.length>=a.settings.maxFiles)||(alert(`El archivo "${t.name}" no puede subrilo, supera el maximo de ${a.settings.maxFiles} archivos para almacenar.`),!1)
            },
            u=function(t,n){
