...
<head>
    <title>Danatura - Compra exitosa</title>
                    ...
                    <tr>
                        <td valign="top" class="td-head">
                            <div class="logo-tienda-container">
                                <table cellpadding="0" cellspacing="0" width="100%" style="max-width:300px;" align="left" border="0" >
                                    <tr>
                                        <td valign="top" class="mobile-center td-logo-tienda" align="left">
                                            <img src="http://danatura.com.mx/assets/images/Logotipo-09.png" class="icon-danatura" alt="">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                        ...
                                        <td align="right" valign="top" class="td-logo-tienda">
                                            <table cellspacing="0" cellpadding="0" border="0" align="right">
                                                <tr>
                                                    ...
                                                    <td style="font-size: 18px; font-weight: 400; line-height: 24px;"> <a href="#" target="_blank" style="color: #ffffff; text-decoration: none;"><img src="https://img.icons8.com/color/48/000000/small-business.png" width="30" height="26" style="display: block; border: 0px;" /></a> </td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 35px 35px 20px 35px; background-color: #ffffff;" bgcolor="#ffffff">
                            <table class="table-center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                                <tr>
                                    <td align="center" style="font-weight: 400; line-height: 24px; padding-top: 25px;"> <img src="https://img.icons8.com/carbon-copy/100/000000/checked-checkbox.png" width="125" height="120" style="display: block; border: 0px;" /><br>
                                        <h2 style="font-size: 30px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;"> ¡Gracias por su compra!  </h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="font-weight: 400; line-height: 24px; padding-top: 10px;">
                                        <p style="font-weight: 400; line-height: 24px; color: #777777;">Estimado {{ $data['nombre'] }}, a continuación le detallamos la compra que acaba de realizar en nuestra página eCommerce </p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="center" valign="top" style="font-size:0;">
                                        ...
                                        <div class="container-info-extra">
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:300px;">
                                                <tr>
                                                    <td align="left" valign="top" style="font-weight: 400; line-height: 24px;">
                                                        <p style="font-weight: 800;">Método de pago:</p>
                                                        <p>{{ $data['method'] }}</p>
                                                    </td>
                                                </tr>
                                            </table>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                                <tr>
                                    <td align="center" style="font-weight: 400; line-height: 24px; padding-top: 25px;">
                                        <h2 style="font-size: 24px; font-weight: 800; line-height: 30px; color: #ffffff; margin: 0;">¡No te pierdas de increíbles productos!</h2>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table class="table-center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                                ...
                                <tr>
                                    <td align="center" class="container-footer">
                                        <p class="font-aviso-privacidad"> Aviso de privacidad | Términos y condiciones © 2021, Todos los derechos reservados. </p>
                                    </td>
                                </tr>
                            </table>
                        </td>
