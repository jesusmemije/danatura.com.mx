...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="{{route('home')}}"><img src="{{asset('assets/images/Sello_DANATURA.png')}}" width="25" alt="Danatura"><span class="m-l-10">Danatura</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-email-open"></i><span>Newsletter</span></a>
                <ul class="ml-menu">
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-email-open"></i><span>Blog</span></a>
                <ul class="ml-menu">
              ...
              <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-notifications-paused"></i><span>Dudas y comentarios</span></a>
                <ul class="ml-menu">
            ...
            <li> <a href="{{route('lista_contacto')}}" class="menu-toggle"><i class="zmdi zmdi-accounts-alt"></i><span>Contacto</span></a>
