...
<body class="theme-orange">
    ...
    <div class="navbar-right">
        <ul class="navbar-nav">
            <li><a data-toggle="modal" data-target="#logoutModal" class="mega-menu" title="Sign Out">
            ...
            <div class="block-header">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-12">
                        <button style="background:#F79860" class="btn btn-primary btn-icon float-right right_icon_toggle_btn" type="button">
