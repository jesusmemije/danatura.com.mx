        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a class="btn btn-danger btn-sm" href="" data-toggle="modal" data-target="#deleteUserModal"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form id="formDelete" action="{{ route('usuario.destroy', 0) }}" data-action="{{ route('usuario.destroy', 0) }}"
          method="POST">
          @method('DELETE')
          @csrf
