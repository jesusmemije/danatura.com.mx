...
<div class="card shadow">
  <div class="card-header">
    ...
    <button data-toggle="modal" data-target="#modalcategoria"
      ...
      <table class="table table-bordered" id="dataTable">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <center>
                <button data-toggle="modal" data-target="#editarcategoria" data-id="{{ $categoria->id}}"
                  data-oldnombre="{{ $categoria->tipo }}" class="btn btn-warning btn-sm"><i
                    class="fa fa-edit"></i></button>
                <button class="btn btn-sm btn-danger btn-circle shadow-sm" data-toggle="modal"
                  data-target="#deleteUserModal" data-id="{{ $categoria->id}}" data-name="{{ $categoria->tipo }}">
...
<!-- Modal -->
<div id="modalcategoria" class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
...
<!-- Modal -->
<div id="editarcategoria" class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
  aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
          ...
          <form action="{{route('editar_categoria')}}" method="post">
            ...
            <div class="row">
              <div class="col">
                ...
                <form id="form-envios" method="post">
                  <label for="">Nombre de la categoría </label>
                  <input readonly id="nombreedit" name="nombrecategoria" type="text" class="form-control"
                    placeholder="">
