      ...
      <table class="table table-bordered" id="dataTable">
        ...
        <tbody>
          ...
          <tr>
            ...
            @endif
            <td>
              <a class="btn btn-info" href="" data-id="{{$duda->id}}" data-nombre="{{$duda->duda_comentario}}"
                data-respuesta="{{$duda->respuesta}}" data-toggle="modal" data-target="#updateDuda">Responder</a>
              <button class="btn btn-danger btn-sm" data-id="{{$duda->id}}" data-nombre="{{$duda->duda_comentario}}"
