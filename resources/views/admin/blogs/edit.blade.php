...
<div class="col-md-12">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('admin/blogs/' .$blogs->id) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PATCH') }}
                <div class="form-group">
                  <label>Título</label>
                  <input type="text" name="titulo" value="{{ $blogs->titulo}}" class="form-control" />
                </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="estatus" id="" class="form-control">
                        <option value="">{{ $blogs->estatus}}</option>
