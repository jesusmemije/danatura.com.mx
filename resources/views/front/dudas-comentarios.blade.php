...
<style>
   .input-gris{
    background-color:white; height:50px; opacity:0.5; color:black !important; border-radius:0px !important;
  }
</style>
  ...
  <div class="row" style="padding:4%; background:#FFE4BB;">
        ...
        <h5 style="color:#F79860; font-weight:bold; font-family:'AmasisMTStd-Bold';">Dudas y comentarios</h5>
          ...
          @csrf
                    ...
                    <label  for="">Escribenos aquí tu duda y con gusto te contestamos </label>
