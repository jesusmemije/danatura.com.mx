...
<div class="container pt-4 pb-4" >
   ...
   $totalPagar = 0;
    ?>
                ...
                <div class="col-md-6 ">
                <hr>
                <button class="btn btn-success mb-4" data-toggle="modal" data-target="#modalenvio"> Datos de envío</button>
                ...
                <input hidden type="text" id="inp-envios">
                  ...
                  <input type="hidden" id="metodo-pago" name="metodopago">
                    ...
                    <div id="pagotarjeta">
                        ...
                        <div class="form-group" style="margin-right:10px;"><strong class="txtrojo">Tarjeta de Crédito / Débito</strong></div>
                        <div class="form-group" style="margin-right:10px;"><strong class="txtgrisc" onClick="document.getElementById('pagotarjeta').style.display='none'; document.getElementById('pagopaynet').style.display='block';" style="cursor:pointer">Efectivo en Oxxo</strong></div>
                        <div class="form-group" style="margin-left:10px;" onclick="validarDatosEnvio()"><strong class="txtgrisc" onClick="document.getElementById('pagotarjeta').style.display='none'; document.getElementById('pagopaynet').style.display='none'; document.getElementById('pagopaypal').style.display='block';" style="cursor:pointer">PayPal</strong><br></div>
                        </div>
                        ...
                        <br>
                        <input type="text" class="form-control" name="nombretarjeta" class="w3-input" maxlength="50" data-conekta="card[name]" autocomplete="off" required><br>

                        Número de Tarjeta
                        <br>
                        <input type="text" class="form-control" name="numtarjeta" class="w3-input" pattern="[0-9]+" maxlength="16" minlength="16" data-conekta="card[number]" onkeypress="return numeros(event)" required><br>
                        ...
                        <div class="w3-row" style="width: 100%">
                            <div class="w3-col" style="width:68%;">
                                ...
                                <br>
                                <select class="form-control" name="mes" class="w3-input" style="width:46%; float:left; margin-right:4%" data-conekta="card[exp_month]" required>
                                    ...
                                    for ($i = 1; $i <= sizeof($meses); $i++) { ?>
                                        <?php if ($i <= 9) : ?>
                                            <option value="<?php echo "0" . $i ?>"><?php echo "0" . $i . " - " . $meses[$i - 1] ?></option>
                                        <?php else : ?>
                                ...
                                <select class="form-control" name="anio" class="w3-input" style="width:46%; float:left; margin-right:4%" data-conekta="card[exp_year]" required>
                            ...
                            <input class="form-control col-lg-4 col-4" type="text" name="CVV" class="w3-input" pattern="[0-9]+" maxlength="4" minlength="3" placeholder="CVV" data-conekta="card[cvc]" onkeypress="return numeros(event)" required>
                        ...
                        <br><button class="btn btn-danger" style="margin-left:25%;" id="pay-button"> &nbsp; &nbsp; Pagar productos &nbsp; &nbsp; </button><br><br>
                    </div>
...
<div id="pagopaynet" style="display:none; padding-bottom:4em">
    ...
    <div class="form-row col-md-12" >
        ...
        <div class="form-group" style="margin-right:10%;"><strong style="cursor:pointer;" class="txtrojo" onClick="document.getElementById('pagotarjeta').style.display='block'; document.getElementById('pagopaynet').style.display='none'; document.getElementById('pagopaypal').style.display='none';" ">Tarjeta de Crédito / Débito</strong></div>
        <div class="form-group" style="margin-right:10px;"><strong class="txtgrisc" style="cursor:pointer">Efectivo en Oxxo</strong></div>
        <div class="form-group" style="margin-left:10px;" onclick="validarDatosEnvio()"><strong class="txtgrisc" onClick="document.getElementById('pagotarjeta').style.display='none'; document.getElementById('pagopaynet').style.display='none'; document.getElementById('pagopaypal').style.display='block';" style="cursor:pointer">PayPal</strong><br></div>
        </div>
    ...
    <br>
                ...
                <div class="form-row col-md-12">
                        ...
                        <div class="form-group" style="margin-right:10%;"><strong style="cursor:pointer;" class="txtrojo" onClick="document.getElementById('pagotarjeta').style.display='block'; document.getElementById('pagopaynet').style.display='none'; document.getElementById('pagopaypal').style.display='none';" ">Tarjeta de Crédito / Débito</strong></div>
                        <div class="form-group" style="margin-right:10px;"><strong class="txtgrisc" onClick="document.getElementById('pagotarjeta').style.display='none'; document.getElementById('pagopaynet').style.display='block'; document.getElementById('pagopaypal').style.display='none';" style="cursor:pointer">Efectivo en Oxxo</strong></div>
                        <div class="form-group" style="margin-left:10%;" onclick="validarDatosEnvio()"><strong class="txtgrisc" onClick="document.getElementById('pagotarjeta').style.display='none'; document.getElementById('pagopaynet').style.display='none'; document.getElementById('pagopaypal').style.display='block';" style="cursor:pointer">PayPal</strong></div>
                        </div> 
...
if($envio_user){
    ...
    echo "<script> enviarData($envio_user); </script>";
