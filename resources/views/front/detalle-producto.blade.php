...
<!--    <li class="nav-item" style="margin-right: 2%;"><a href="" target="_blank" class="icon-facebook"> 
          <i style="font-size:22px; padding-left:11px;" class="fab fa-facebook-f fa-sm ri-face"></i></a></li>-->
          <li class="nav-item" style="margin-top:-1%; margin-left: 2%;"><a href="" target="_blank" class="icon-instagram">
    ...
    <ul class="lightSlider">
      @for ($i = 1; $i < sizeof($array_galeria); $i++)
      @if ($array_galeria[$i]!="")
          
   
      <li>
        <div style="padding:4%;">
         <img onclick="changeimg(this);" style="cursor:pointer" class="img-thumbnail" src="{{$array_galeria[$i]}}" alt="">
        </div>
        </li>  
        @endif
      @endfor
  ...
  <div class="row pt-5" style="">
      <div class="col-md-12 " >
        ...
        <div class="row d-flex justify-content-center" style="color:#fb985f; font-size:3em; font-family:AmasisMTStd-Bold; ">MÁ S VENDIDOS</div>
      </div>
      <style>
        .cls2{
          color:#73472b;
