                        ...
                        <tbody>
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><?php  $totalPagar = $carrito[$i]['cantidad'] * $producto->precio+ $totalPagar;
                                            ...
                                            <td>
                                                ...
                                                <a onclick="remove('{{$producto->id}}')" class="btn btn-danger waves-effect waves-float btn-sm waves-red"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                        ...
                        <div class="col-md-12" >
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{route('checkout')}}"  class="btn btn-success"> Pagar ahora <i style="color:white" class="fas fa-credit-card"></i></a>
