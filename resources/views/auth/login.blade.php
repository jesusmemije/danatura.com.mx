...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center" style="font-size: 32px; font-weight: bold;">{{ __('Iniciar sesión') }}</div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-3 text-center">
                                ...
                                <div class="mt-3">
                                    {{ __('¿Aún no tienes una cuenta?') }} <a class="btn-link" href="{{ route('registrarse') }}">
                                        {{ __('Regístrate') }}
                                    </a>
                                </div>
